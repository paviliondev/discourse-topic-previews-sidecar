...
class TopicPreviewss::Subscription
  ...
  def initialize
    @authentication = TopicPreviewss::Subscription::Authentication.new(get_authentication)
    @subscription = TopicPreviewss::Subscription::Subscription.new(get_subscription)
  end
  ...
  def set_subscription(type)
    PluginStore.set(TopicPreviewss::Subscription.namespace, subscription_db_key, type: type, updated_at: Time.now)
    TopicPreviewss::Subscription::Subscription.new(get_subscription)
  end
  ...
  def set_authentication(key, user_id)
    ...
    TopicPreviewss::Subscription::Authentication.new(get_authentication)
  end
